const getProductsByName = {
    get: {
      ...
      requestBody: {
        ...
        content: {
          ...
          'application/json': {
            schema: {
              $ref: '#/components/schemas/getProductsByNameInput', // Reference to the JSON schema for the input object (defined elsewhere)
            },
          },
        },
      },
        ...
        '200': {
          ...
          content: {
            ...
            'application/json': {
              // Payload format
              schema: {
                $ref: '#/components/schemas/getProductsByNameResponse', // Reference to response schema
              },
            },
          },
        },
  ...
  module.exports = getProductsByName // Exporting the object containing the API definition
